...
class SessionFsmPoemTitleMatchTest {
    ...
    @Test
    fun finished_whenTraditionalHuanShouIntent_shouldRestart() {
        val state = stateOf(SessionStateType.FINISHED) {
            selectedPoem = SamplePoems.poems.first()
        }
    ...
    @Test
    fun finished_whenTraditionalChongLaiYiShouIntent_shouldRestart() {
        val state = stateOf(SessionStateType.FINISHED) {
            selectedPoem = SamplePoems.poems.first()
        }
    ...
    @Test
    fun finished_whenTraditionalChongXinLaiYiShouIntent_shouldRestart() {
        val state = stateOf(SessionStateType.FINISHED) {
            selectedPoem = SamplePoems.poems.first()
        }
    ...
    @Test
    fun reciting_whenBuyongBeiLeIntent_shouldExitSession() {
        val poem = SamplePoems.poems.first()
        val state = stateOf(SessionStateType.RECITING) {
            selectedPoem = poem
            currentLineIdx = 0
    ...
    @Test
    fun reciting_whenBuyongBeiSongLeIntent_shouldExitSession() {
        val poem = SamplePoems.poems.first()
        val state = stateOf(SessionStateType.RECITING) {
            selectedPoem = poem
            currentLineIdx = 0
    ...
    @Test
    fun reciting_whenBuXiangBeiLeIntent_shouldExitSession() {
        val poem = SamplePoems.poems.first()
        val state = stateOf(SessionStateType.RECITING) {
            selectedPoem = poem
            currentLineIdx = 0
    ...
    @Test
    fun reciting_whenBuXiangBeiSongLeIntent_shouldExitSession() {
        val poem = SamplePoems.poems.first()
        val state = stateOf(SessionStateType.RECITING) {
            selectedPoem = poem
            currentLineIdx = 0
    ...
    @Test
    fun reciting_whenBuXiangBeiShiLeIntent_shouldExitSession() {
        val poem = SamplePoems.poems.first()
        val state = stateOf(SessionStateType.RECITING) {
            selectedPoem = poem
            currentLineIdx = 0
    ...
    @Test
    fun waitPoemName_whenTraditionalRepeatIntentWithShuoYiCi_shouldReplayPrompt() {
        val state = stateOf(SessionStateType.WAIT_POEM_NAME)
    ...
    @Test
    fun waitPoemName_whenTraditionalRepeatIntentWithTingYiCi_shouldReplayPrompt() {
        val state = stateOf(SessionStateType.WAIT_POEM_NAME)
    ...
    @Test
    fun waitPoemName_whenRepeatUtteranceContainsHintWords_shouldReplayPrompt() {
        val state = stateOf(SessionStateType.WAIT_POEM_NAME)
    ...
    @Test
    fun finished_whenRepeatPhraseChongLaiYiBian_shouldReplayFinishedPrompt() {
        val state = stateOf(SessionStateType.FINISHED) {
            selectedPoem = SamplePoems.poems.first()
        }
