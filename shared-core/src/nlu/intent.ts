...
const KEYWORDS = {
  ...
  exit: ['退出', '结束', '停止', '不背了', '不背诵了', '不背诗了', '不用背了', '不用背诵了', '不用背诗了', '不想背了', '不想背诵了', '不想背诗了'],
  next: ['下一首', '换一首', '换首', '换诗', '再来一首', '再来首', '重来一首', '重来首', '重新来一首', '重新来首'],
  repeat: ['再说一遍', '再说一次', '再讲一遍', '再讲一次', '再听一遍', '再听一次', '重复', '再来一次', '再来一遍', '重来一次', '重来一遍']
}
