...
describe('session_fsm', () => {
  ...
  test('buyongbeisongle command exits active session and stops listening', () => {
    const ctx = makeCtx()
    const initial = createInitialSession({ ...ctx, lastUserActiveAt: now })
    const reciting = {
      ...initial,
  ...
  test('bubeisongle command exits active session and stops listening', () => {
    const ctx = makeCtx()
    const initial = createInitialSession({ ...ctx, lastUserActiveAt: now })
    const reciting = {
      ...initial,
  ...
  test('bubeishile command exits active session and stops listening', () => {
    const ctx = makeCtx()
    const initial = createInitialSession({ ...ctx, lastUserActiveAt: now })
    const reciting = {
      ...initial,
  ...
  test('traditional shuo-yici repeat command replays current prompt in WAIT_POEM_NAME', () => {
    const ctx = makeCtx()
    const initial = createInitialSession(ctx)
    const started = sessionReducer(initial, { type: 'USER_UI_START' })
    const repeated = sessionReducer(started.state, {
  ...
  test('traditional jiang-yici repeat command replays current prompt in WAIT_POEM_NAME', () => {
    const ctx = makeCtx()
    const initial = createInitialSession(ctx)
    const started = sessionReducer(initial, { type: 'USER_UI_START' })
    const repeated = sessionReducer(started.state, {
  ...
  test('traditional ting-yici repeat command replays current prompt in WAIT_POEM_NAME', () => {
    const ctx = makeCtx()
    const initial = createInitialSession(ctx)
    const started = sessionReducer(initial, { type: 'USER_UI_START' })
    const repeated = sessionReducer(started.state, {
  ...
  test('finished traditional huanshou command should reset poem-scoped session context', () => {
    const ctx = makeCtx()
    const initial = createInitialSession(ctx)
    const finished = {
      ...initial,
  ...
  test('finished zailaishou command should reset poem-scoped session context', () => {
    const ctx = makeCtx()
    const initial = createInitialSession(ctx)
    const finished = {
      ...initial,
  ...
  test('finished traditional chonglaiyishou command should reset poem-scoped session context', () => {
    const ctx = makeCtx()
    const initial = createInitialSession(ctx)
    const finished = {
      ...initial,
  ...
  test('finished traditional chongxinlaiyishou command should reset poem-scoped session context', () => {
    const ctx = makeCtx()
    const initial = createInitialSession(ctx)
    const finished = {
      ...initial,
